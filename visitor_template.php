      ...
      <div class="row">
        <div class="col-md-8 order-md-1">
          ...
          <div class="flex h-screen w-full" id="visitor-counter" >
            <div class="bg-transparent w-full md:w-1/2 px-8 pt-8 pb-3 flex flex-col justify-between">
        <div>
            <h3 class="font-light-muted mb-2"><?= __('Selamat datang di Perpustakaan ').$sysconf['library_name']; ?></h3>
            <p class="lead">
                <?= __('Silakan isi Nomer Anggota Perpustakaan atau Nama Anda.')?>
            </p>
            ...
            <form class="mt-4" @submit.prevent="onSubmit">
                <div class="form-group">
                    ...
                    <input v-model="memberId" ref="memberId" autofocus type="text" class="form-control" id="exampleInputEmail1"
                           aria-describedby="emailHelp" placeholder="<?= __('Masukkan Nomer Anggota Anda')?>">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1"><?= __('Institusi/Lembaga/Kelas/dan sejenisnya.')?></label>
                    <input v-model="institution" type="text" class="form-control" id="exampleInputPassword1"
                           placeholder="<?= __('Enter your institution')?>">
                    <small id="emailHelp" class="form-text text-muted"><?= __('Cukup masukkan Nomer Anggota Perpustakaan, jika Anda memiliki Kartu Anggota Perpustakan ').$sysconf['library_name']; ?></small>
                </div>
                <button type="submit" class="btn btn-primary btn-block"><?= __('MASUK/ENTER')?></button>
            </form>
        </div>
        <div class="text-right">
            <small class="text-red-dark"><?= __('+by')?> <code>maseko</code></small>
        </div>
    </div>
            <div class="flex-1 hidden md:block">
              <div class="h-screen">
                ...
                <blockquote class="blockquote" v-show="textInfo === ''">
                    <div id="carouselContent" class="carousel slide" data-interval="3500" data-ride="carousel">
                        <div class="carousel-inner text-white" role="listbox">
                            <div class="carousel-item p-4">
                                 <p>Untuk menaklukkan dirinya sendiri adalah kemenangan terbesar yang bisa diperoleh manusia.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item active p-4">
                                 <p>Menemukan Tuhan dalam Segala Hal.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Berdoalah seolah-olah Tuhan akan mengurus semuanya; bertindak seolah-olah semuanya terserah Anda.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Kebenaran selalu berakhir dengan kemenangan; itu tidak bisa disangkal, tetapi tak terkalahkan.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Jika Tuhan menyebabkan Anda sangat menderita, itu adalah tanda bahwa Ia tentu saja ingin menjadikan Anda orang suci.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Kemalasan adalah pancing neraka untuk menangkap jiwa.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Dia yang telah mendengar Firman Tuhan dapat menanggung kesunyiannya.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Berdiri teguh dan tak tergoyahkan seperti landasan ketika dipukuli.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Tuhan tidak akan kalah dalam kemurahan hati.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Tidak sulit untuk patuh ketika kita mengasihi orang yang kita taati.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Keputusasaan bukanlah dari Tuhan.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
                                 <p>Mari kita bekerja seolah-olah kesuksesan bergantung pada diri kita sendiri, tetapi dengan keyakinan yang tulus bahwa kita tidak melakukan apa-apa, dan Tuhan adalah segalanya.</p>
                                 <footer class="blockquote-footer text-grey-light">Ignatius of Loyola</footer>
                            </div>
                            <div class="carousel-item p-4">
          ...
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between bg-light">
              <div class="text-success">
                ...
                <small>Perpustakaan SD Marsudirini Yogyakarta</small>
              </div>
    ...
    new Vue({
        ...
        methods: {
            ...
            onSubmit: function() {
                ...
                let url = 'index.php?p=visitor&room=200'
